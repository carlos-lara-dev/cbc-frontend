...
export const getQuizService = async (id) => {
    try {
        const request = await axios.get(`http://localhost:4500/quiz/v1/quiz/${id}`);
        return request
    } catch (error) {
        return null
    }
...
export const getPresentationService = async (id) => {
    try {
        const data = await axios.get(`http://localhost:4500/quiz/v1/presentation/quiz/${id}`)
        return data
    } catch (error) {
        return null
    }
...
export const getQuestionsService = async (id) => {
    try {
        const data = await axios.get(`http://localhost:4500/quiz/v1/question/quiz/${id}`)
        return data
    } catch (error) {
        return null
    }
...
export const getExtraOpportunity = async (idUser, idQuiz) => {
    try {
        const extraData = await axios.get(`http://localhost:4500/quiz/v1/user-attempts-quiz/${idUser}/${idQuiz}`);
...
export const getUserModuleResult = async (idUser, idQuiz) => {
    try {
        const data = await axios.get(`http://localhost:4500/quiz/v1/user/${idUser}/quiz/${idQuiz}/aproved`)
        return data
    } catch (error) {
        return null
    }
...
export const setScoreUser = async (params) => {
    try {
        const scoreUser = await axios.post(`http://localhost:4500/quiz/v1/user-score-quiz`, params);
